...
def run_cell(args):
    ...
    def sandwich_fields(fit, W):
        ...
        # prop:local-misalignment interval widening (main.tex "Interval validity under local
        # misalignment"): restores nominal coverage for contrasts not represented by col(W).
        try:
