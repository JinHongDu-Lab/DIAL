...
python -m experiments.real_data.intermediate_budget_plot --root /tmp/dial-intermediate-budget
```
...
python -m experiments.real_data.intermediate_budget_plot --root /tmp/dial-intermediate-budget-50
